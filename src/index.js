    ...
    try {
        ...
        page.on('console', msg => {
          ...
          if (text === 'banned') {
            ...
            const status = `Foi banido às ${hour}:${minute}`;
            console.log(status);
            const twit = new twitModule(twitConfig)
            twit.post('statuses/update', {status }, (err, data, response) => {
              if (err)
                console.log(err);
              else 
                console.log('a');
            })
            console.log('Leo has been banned');
          }
        })
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
